...
<head>
	...
	<link rel="stylesheet" href="{{asset('frontend/assets/css/johndoe.css')}}" >
</head>
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                ...
                <h1 class="header-title">Programmer Sohan</h1>
                <h6 class="header-mono" >Full Stack Developer & Lifetime Learner</h6>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    <img src="{{asset('frontend/assets/imgs/avatar.jpg')}} " alt="" class="brand-img">
                    <li class="brand-txt">
                ...
                <div class="portfolio-container"> 
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/web-1.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/web-1.jpg')}}"></a>
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/web-2.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/web-2.jpg')}} "></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/advertising-2.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                         
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/advertising-2.jpg')}} "></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/web-4.jpg')}}" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/web-4.jpg')}}"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising"> 
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/advertising-1.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                               
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/advertising-1.jpg')}}"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/web-3.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">  
                           <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/web-3.jpg')}} "></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/advertising-3.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">       
                           <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/advertising-3.jpg')}} "></a>
                                <div class="text-holder">
                                    <h6 class="title">ADVERSITING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new"> 
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/advertising-4.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">            
                            <div class="content-holder">
                          <a class="img-popup" href="{{asset('frontend/assets/imgs/advertising-4.jpg')}} "></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/branding-1.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                        
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/branding-1.jpg')}} "></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/branding-2.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">  
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/branding-2.jpg')}} "></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/branding-3.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">   
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/branding-3.jpg')}} "></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/branding-4.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                      
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/branding-4.jpg')}} "></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="{{asset('frontend/assets/imgs/branding-5.jpg')}} " class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">          
                            <div class="content-holder">
                                <a class="img-popup" href="{{asset('frontend/assets/imgs/branding-5.jpg')}} "></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
            ...
            <div class="row">
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="{{asset('frontend/assets/imgs/blog1.jpg')}} " alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="{{asset('frontend/assets/imgs/blog2.jpg')}} " alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="{{asset('frontend/assets/imgs/blog3.jpg')}} " alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
    ...
    <!-- Isotope  -->
    <script src="{{asset('frontend/assets/vendors/isotope/isotope.pkgd.js')}} "></script>
